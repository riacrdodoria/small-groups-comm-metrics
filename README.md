...
| 01 | `analysis/01_lsh/` | `data/anonymized/startup/`, `data/raw/gorman/` | `data/processed/lsh/` | Computes locality-sensitive hashing or related semantic similarity representations from the communication sequences. |
